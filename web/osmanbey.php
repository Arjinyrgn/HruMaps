...
<select id="start">
 <?php
        ...
        $cek=mysqli_query($link,"select * from hrumaps where aktiflik=1 and yerleske_id=3 order by h_id asc ");
...
<br>
 ...
 <div class="container">
 <center><h1>Osmanbey Kampüsüne Hoşgeldiniz</h1></center>
    <script>
	   var customLabel = {  1: {
          label: 'F'
        },
        ...
        var map = new google.maps.Map(document.getElementById('map'), {
          center: new google.maps.LatLng(37.172329,39.00110),
          zoom: 15.2
        });
