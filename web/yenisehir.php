...
<select id="start">
 <?php
        ...
        $cek=mysqli_query($link,"select * from hrumaps where aktiflik=1 and yerleske_id=2 order by h_id asc ");
...
<div class="container">
 <center><h1>Yenişehir Kampüsüne Hoşgeldiniz</h1></center>
    <script>
	   var customLabel = { 
	    1: {
          label: 'F'
        ...
        var map = new google.maps.Map(document.getElementById('map'), {
          center: new google.maps.LatLng(37.175637, 38.799727),
          zoom: 15.2
        });
